...
import br.com.fiap.tds.tdspa.javaadv.blogBackend.datasource.repositories.OrderRepositoryCustom;
...
public class OrderRepositoryCustomImpl implements OrderRepositoryCustom {
    ...
    public List<Order> findByTotalQuantityGreaterThanQueryDsl(Integer quantity) {
        ...
        // BooleanExpression predicate = order.totalQuantity
        //        .gt(quantity);

        // var jpaQueryFactiory = new JPAQueryFactory(entityManager);

        // return jpaQueryFactiory.selectFrom(order).where(predicate)
        //        .fetch();
    ...
    public List<Order> findByTotalQuantityGreaterThanCriteria(Integer quantity) {
        ...
        predicates.add(builder.greaterThan(orderRoot.get("totalQuantity"), quantity));
